...
public class SchedulerApplicationAttempt {
  ...
  private long lastGcoreSeconds = 0;
  ...
  protected NoNullHashMap<String, Resource> currentConsumption = new NoNullHashMap<String, Resource>(){};
  ...
  public NoNullHashMap<String, Resource> getCurrentConsumption() {
