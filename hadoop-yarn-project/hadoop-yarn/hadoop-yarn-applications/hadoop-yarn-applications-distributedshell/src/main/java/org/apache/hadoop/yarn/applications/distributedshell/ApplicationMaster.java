...
public class ApplicationMaster {
  ...
  // gpucores to request for the container on which the shell command will run
  ...
  public boolean init(String[] args) throws ParseException, IOException {
    ...
    opts.addOption("container_gcores", true,
            "Amount of gpu cores to be requested to run the shell command");
    ...
    containerVirtualCores = Integer.parseInt(cliParser.getOptionValue(
        "container_vcores", "1"));
    containerGpuCores = Integer.parseInt(cliParser.getOptionValue(
            "container_gcores", "0"));
  ...
  public void run() throws YarnException, IOException, InterruptedException {
    ...
    int maxGCores = response.getMaximumResourceCapability().getGpuCores();
    LOG.info("Max gcores capabililty of resources in this cluster " + maxGCores);
    ...
    if (containerGpuCores > maxGCores) {
      LOG.info("Container gpu cores specified above max threshold of cluster."
              + " Using max value." + ", specified=" + containerGpuCores + ", max="
              + maxGCores);
      containerGpuCores = maxGCores;
    }
